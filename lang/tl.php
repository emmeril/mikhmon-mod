...
$_reset_mac_lock = "I-reset ang MAC Lock";
$_mac_lock_count = "%s / %s naka-lock na user";
$_mac_lock_router_offline = "Hindi nakakonekta ang MikroTik router.";
$_mac_lock_read_user_failed = "Hindi mabasa ang user";
$_mac_lock_user_not_found = "Hindi nakita ang Hotspot user.";
$_mac_lock_already_empty = "Wala nang MAC lock ang user na ito.";
$_mac_lock_reset_success = "Na-reset ang MAC lock ni %s. Naputol na session: %d, naburang cookie: %d.";
$_mac_lock_profile_updated = "Na-update din ang profile script para awtomatikong ma-lock ang bagong MAC.";
$_mac_lock_cleanup_note = "Tala sa paglilinis";
$_mac_lock_load_profiles_failed = "Hindi ma-load ang mga profile na may Lock User";
$_mac_lock_load_users_failed = "Hindi ma-load ang mga MAC lock";
$_mac_lock_description = "Buburahin ng reset ang voucher MAC, puputulin ang aktibong session, at aalisin ang lumang cookie. Ang susunod na device na mag-login ang siyang mala-lock.";
$_mac_lock_search_placeholder = "Maghanap ng username, profile, server, o MAC...";
$_mac_lock_all_profiles = "Lahat ng Profile";
$_mac_lock_all_statuses = "Lahat ng Status";
$_mac_lock_active = "Aktibo";
$_mac_lock_inactive = "Hindi aktibo";
$_mac_lock_server = "Server";
$_mac_lock_locked_mac = "Naka-lock na MAC";
$_mac_lock_status = "Status";
$_mac_lock_reset_button = "I-reset ang MAC";
$_mac_lock_empty = "Walang user na may MAC lock.";
$_mac_lock_no_results = "Walang MAC lock na tumutugma sa filter.";
$_mac_lock_reset_confirm = "I-reset ang MAC lock ni %s? Puputulin ang aktibong session ng lumang device.";
$_mac_lock_invalid_user = "Hindi wasto ang data ng user.";
$_mac_lock_clear_failed = "Hindi mabura ang MAC";
$_mac_lock_invalid_profile = "Hindi wasto ang user profile.";
$_mac_lock_read_profile_failed = "Hindi mabasa ang profile";
$_mac_lock_profile_not_found = "Hindi nakita ang user profile.";
$_mac_lock_profile_disabled = "Hindi naka-enable ang Lock User sa profile na ito.";
$_mac_lock_profile_update_failed = "Hindi ma-update ang profile lock";
$_mac_lock_cookie = "cookie";
$_mac_lock_active_session = "aktibong session";
$_mac_lock_invalid_router_response = "Hindi wasto ang sagot ng router.";
$_log = "logs";
$_logout = "Lumabas";
$_messages = "Mensahe";
$_min = "min";
...
<ul>
<li>None: Gamitin ito para sa customer profile na pinamamahalaan ng Billing. Ang expiration, due date, at isolation ay kontrolado ng Billing automation.</li>
