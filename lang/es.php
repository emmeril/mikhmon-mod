...
$_reset_mac_lock = "Restablecer bloqueo MAC";
$_mac_lock_count = "%s / %s usuarios bloqueados";
$_mac_lock_router_offline = "El router MikroTik no está conectado.";
$_mac_lock_read_user_failed = "No se pudo leer el usuario";
$_mac_lock_user_not_found = "No se encontró el usuario Hotspot.";
$_mac_lock_already_empty = "El bloqueo MAC de este usuario ya está vacío.";
$_mac_lock_reset_success = "Se restableció el bloqueo MAC de %s. Sesiones desconectadas: %d, cookies eliminadas: %d.";
$_mac_lock_profile_updated = "También se actualizó el script del perfil para bloquear automáticamente la nueva MAC.";
$_mac_lock_cleanup_note = "Nota de limpieza";
$_mac_lock_load_profiles_failed = "No se pudieron cargar los perfiles de bloqueo de usuario";
$_mac_lock_load_users_failed = "No se pudieron cargar los bloqueos MAC";
$_mac_lock_description = "El restablecimiento borra la MAC del vale, desconecta las sesiones activas y elimina las cookies antiguas. El siguiente dispositivo que inicie sesión quedará bloqueado.";
$_mac_lock_search_placeholder = "Buscar usuario, perfil, servidor o MAC...";
$_mac_lock_all_profiles = "Todos los perfiles";
$_mac_lock_all_statuses = "Todos los estados";
$_mac_lock_active = "Activo";
$_mac_lock_inactive = "Inactivo";
$_mac_lock_server = "Servidor";
$_mac_lock_locked_mac = "MAC bloqueada";
$_mac_lock_status = "Estado";
$_mac_lock_reset_button = "Restablecer MAC";
$_mac_lock_empty = "No hay usuarios con bloqueo MAC.";
$_mac_lock_no_results = "No hay bloqueos MAC que coincidan con los filtros.";
$_mac_lock_reset_confirm = "¿Restablecer el bloqueo MAC de %s? Se desconectará la sesión activa del dispositivo anterior.";
$_mac_lock_invalid_user = "Los datos del usuario no son válidos.";
$_mac_lock_clear_failed = "No se pudo borrar la MAC";
$_mac_lock_invalid_profile = "El perfil de usuario no es válido.";
$_mac_lock_read_profile_failed = "No se pudo leer el perfil";
$_mac_lock_profile_not_found = "No se encontró el perfil de usuario.";
$_mac_lock_profile_disabled = "Este perfil no tiene activado Bloquear Usuario.";
$_mac_lock_profile_update_failed = "No se pudo actualizar el bloqueo del perfil";
$_mac_lock_cookie = "cookie";
$_mac_lock_active_session = "sesión activa";
$_mac_lock_invalid_router_response = "La respuesta del router no es válida.";
$_log = "Log";
