...
if (isset($_GET['logout'])) { unset($_SESSION['mikhmon'], $_SESSION['mikhmon_role'], $_SESSION['mikhmon_customer_id'], $_SESSION['mikhmon_customer_session'], $_SESSION['mikhmon_name'], $_SESSION['mikhmon_customer_expires_at'], $_SESSION['customer_otp_phone']); header('Location: pelanggan'); exit; }
$message = ''; $error = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'request_otp') {
    ...
    if (mikhmonVerifyCustomerOtp($phone, (string) ($_POST['otp'] ?? ''))) {
      $customer = mikhmonFindCustomerByPhone($phone); mikhmonSetCustomerSession($customer, $customer['_session'] ?? ''); unset($_SESSION['customer_otp_phone']); header('Location: pelanggan'); exit;
