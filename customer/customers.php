...
$(function() {
  ...
  function showSelectedCustomerAccount(select) {
    ...
    var isOnline = option.attr('data-online') === 'true';
    row.find('.customer-online-indicator').toggleClass('is-online', isOnline).attr('data-online', isOnline ? 'true' : 'false').attr('title', isOnline ? 'Layanan online' : 'Layanan offline').attr('aria-label', isOnline ? 'Layanan online' : 'Layanan offline');
