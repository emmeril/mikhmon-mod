...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'create_invoice') {
    ...
    elseif ($unpaidInvoiceIndex >= 0) $customerMessage = 'Invoice berikutnya sudah tersedia: ' . ($invoices[$unpaidInvoiceIndex]['number'] ?? '-') . '. Gunakan invoice tersebut, bukan membuat duplikat baru.';
