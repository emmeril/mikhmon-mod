...
$midtransPaymentAvailable = !empty($paymentGatewayConfig['enabled']) && !empty($paymentGatewayConfig['midtrans']['enabled']) && $paymentGatewayConfig['midtrans']['server_key'] !== '';
...
<div class="row"><div class="col-12"><div class="card">
  ...
  <div class="card-body">
    ...
    <?php foreach ($customers as $index => $customer):
      ...
      $nextHasPaymentLink = !$midtransPaymentAvailable || !empty($nextUnpaidInvoice['payment_url']);
      ...
      $nextCanCreatePayment = $nextBillingOpen && $midtransPaymentAvailable && $nextUnpaidInvoice && !$nextPaymentUrl;
