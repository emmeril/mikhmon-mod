...
<button class="btn bg-primary" name="save" onclick="loader()"><i class="fa fa-save"></i> <?= $_save ?></button> <a class="btn bg-warning" href="./?ppp=secrets&session=<?= $session ?>"><i class="fa fa-close"></i> <?= $_close ?></a>
</form>
