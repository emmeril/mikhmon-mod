...
if (isset($_POST['database_action'])) {
  if ($_POST['database_action'] === 'backup') {
    ...
    $result = mikhmonRestoreRouterData($API, $session, $restoreType);
...
<div class="row"><div class="col-12"><div class="card">
  ...
  <div class="card-body">
    ...
    <p><strong>Backup terakhir:</strong> <?= htmlspecialchars($updatedAt, ENT_QUOTES); ?> &nbsp; | &nbsp; Hotspot: <?= count(isset($snapshot['hotspot_users']) ? $snapshot['hotspot_users'] : array()); ?> &nbsp; | &nbsp; PPPoE: <?= count(isset($snapshot['ppp_secrets']) ? $snapshot['ppp_secrets'] : array()); ?></p>
